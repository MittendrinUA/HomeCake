      ...
      <div className="fixed inset-0 z-[150] flex items-end justify-center sm:items-center sm:p-4">
          ...
          className="relative w-full max-w-md bg-[#1E1919] border border-[#2A2323] rounded-t-[40px] sm:rounded-[40px] shadow-2xl overflow-hidden">
            ...
            <div className="p-8 pb-10 flex flex-col items-center text-center">
              ...
              'Ви досягли ліміту безкоштовної версії (15 інгредієнтів). '}{t("auto.t_98", "Отримайте підписку, щоб створювати безліч рецептів, вести облік складу та аналізувати продажі без обмежень.")}
              ...
              <div className="w-full space-y-4 text-left mb-8 bg-[#151212] p-6 rounded-3xl border border-[#2A2323]">
                 <div className="flex items-center gap-3">
                   ...
                   <p className="text-[#F4EFEA] text-sm font-medium">{t("auto.t_99", "Безлімітні рецепти")}</p>
                 </div>
                 <div className="flex items-center gap-3">
                   <div className="w-2 h-2 rounded-full bg-[#D4AF37]"></div>
                   <p className="text-[#F4EFEA] text-sm font-medium">{t("auto.t_100", "Безлімітний склад")}</p>
                 </div>
                 <div className="flex items-center gap-3">
                   <div className="w-2 h-2 rounded-full bg-[#D4AF37]"></div>
                   <p className="text-[#F4EFEA] text-sm font-medium">{t("auto.t_101", "Розширена аналітика (незабаром)")}</p>
                 </div>
              </div>
              ...
              target="_blank"
              rel="noreferrer"
              className="w-full py-4 bg-gradient-to-r from-[#D4AF37] to-[#F4EFEA] text-[#151212] font-bold rounded-2xl shadow-lg active:scale-95 transition-transform uppercase tracking-widest text-sm flex items-center justify-center">{t("auto.t_102", "Отримати підписку")}
